...
void EXTI0_IRQHandler(void)
{
	...
	I2C_MasterSendDataIT(I2C1, (uint8_t*)command, 7, 0x68, ENABLE);

//	uint8_t sizeOfData=0;
//	I2C_MasterReceiveData(I2C1, &sizeOfData, 1, 0x68, DISABLE);
//
//	command = 0x52;
//	I2C_MasterSendData(I2C1, &command, 1, 0x68, DISABLE);
//
//	uint8_t dataBuffer[100]={0};
//	I2C_MasterReceiveData(I2C1, dataBuffer, sizeOfData, 0x68, ENABLE);
}
